...
const sizeClasses = {
  ...
  default:
    "animate rounded-full px-3.5 py-2 font-medium text-center text-[12px] tracking-wide flex align-middle items-center justify-center",
  lg: "animate rounded-full px-4 py-3 text-center font-medium text-sm flex align-middle items-center justify-center",
};
